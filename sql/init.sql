...
CREATE TABLE `sys_user` (
                            ...
                            `wechat_group` varchar(64) DEFAULT NULL,
                            ...
                            `company_type` varchar(16) DEFAULT NULL COMMENT '企业性质',
                            `company_scale` varchar(16) DEFAULT NULL COMMENT '企业规模',
                            `show_phone` tinyint DEFAULT NULL COMMENT '是否展示手机号',
                            `show_email` tinyint DEFAULT NULL COMMENT '是否展示邮件',
                            `show_wechat` tinyint DEFAULT NULL COMMENT '是否展示微信号',
                            PRIMARY KEY (`id`) USING BTREE,
                            UNIQUE KEY `username` (`username`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb3 COMMENT='系统用户表';
